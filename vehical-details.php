...
<div class="sidebar_widget">
  ...
  <form method="post" onsubmit="return validateDates()">
    <div class="form-group">
      ...
      <input type="date" id="fromdate" class="form-control" name="fromdate" min="" required>
    </div>
    <div class="form-group">
      <label>To Date:</label>
      <input type="date" id="todate" class="form-control" name="todate" min="" required>
    </div>
    <div class="form-group">
...
<script>
// Set the minimum date for "From Date" and "To Date"
